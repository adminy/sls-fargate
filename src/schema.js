const ram = [256, 512, 1024, 2048, 4096, 8192, 16384]
const arch = ['X86_64', 'ARM64']
const logsKeepDays = [1, 3, 5, 7, 14, 30, 60, 90, 120, 150, 180, 365, 400, 545, 731, 1827, 2192, 2557, 2922, 3288, 3653]
...
module.exports = {
  ...
  properties: {
    ...
    memory: { type: 'string' },
    cpu: { type: 'integer', enum: ram },
    architecture: { type: 'string', enum: arch },
    portMappings: {
      type: 'array',
      items: {
        type: 'object',
        properties: {
          ...
          containerPortRange: { type: 'string' },
        }
      }
    },
    ...
    logRetentionInDays: { type: 'integer', enum: logsKeepDays },
